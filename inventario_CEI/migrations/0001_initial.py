# Generated by Django 2.0.3 on 2018-07-10 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(blank=True, choices=[('d', 'Disponible'), ('e', 'En Prestamo'), ('p', 'Perdido')], default='d', help_text='Estado del prestamo', max_length=1)),
            ],
            options={
                'ordering': ['nombre'],
            },
